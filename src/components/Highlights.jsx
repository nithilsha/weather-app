import React from 'react'
 ...
 function Highlights  ({stats}) {
  return (
    <div className='bg-slate-600 p-2 text-slate-200 flex flex-col justify-normal items-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer'>
...

{
  stats.title == "Humidity" ?(
    ...
    <div className=" mt-4 w-full bg-gray-200 rounded-full h-1.5 mb-4 dark:bg-gray-700">
